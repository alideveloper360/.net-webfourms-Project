<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeAdvanceSalary.aspx.cs" Inherits="SalesApp.EmployeeAdvanceSalary" %>
    ...
    <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="#">Advance Salary Report</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col s12">
                                                    <asp:Button Text="Submit" runat="server" ID="btnAddLoan" CssClass="btn btn-large" OnClick="btnAddLoan_Click" />
