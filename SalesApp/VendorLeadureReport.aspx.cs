...
namespace SalesApp
{
    public partial class VendorLeadureReport : System.Web.UI.Page
    {
        ...
        {
            string query = "select VendorPay.Id, Vendors.strName, VendorPay.GRN, VendorPay.TotalTP, VendorPay.Date, VendorPay.PaidAmount,VendorPay.payable, VendorPay.Description from VendorPay inner join Vendors on VendorPay.Vendor = Vendors.nv_Id where Vendor='"+ ddlFilterCommittee.SelectedValue + "'";
        ...
        {
            string query = "select VendorPay.Id, Vendors.strName, VendorPay.GRN, VendorPay.TotalTP, VendorPay.Date, VendorPay.PaidAmount,VendorPay.payable, VendorPay.Description from VendorPay inner join Vendors on VendorPay.Vendor = Vendors.nv_Id";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            DataSet ds = new DataSet();
            sda.Fill(ds);
            gvCommittee.DataSource = ds;
