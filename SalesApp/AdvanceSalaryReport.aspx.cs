...
namespace SalesApp
{
    public partial class AdvanceSalaryReport : System.Web.UI.Page
    {
        ...
        {
            string query = "select AdvanceSalaryReport.id, tbl_Employees.strName, AdvanceSalaryReport.Total_Amount, AdvanceSalaryReport.Date from AdvanceSalaryReport inner join tbl_Employees on tbl_Employees.strCode=AdvanceSalaryReport.emp_Code where bisDeleted='0'";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            DataSet ds = new DataSet();
            sda.Fill(ds);
        ...
        {
            //SqlDataAdapter sda = new SqlDataAdapter("select tbl_Employees.strName from AdvanceSalary inner join tbl_Employees on AdvanceSalary.Name=tbl_Employees.Id", con);
            //DataSet ds = new DataSet();

            //sda.Fill(ds);

            //ddlFilterCommittee.DataTextField = "strName";
            //ddlFilterCommittee.DataValueField = "emp_Code";
