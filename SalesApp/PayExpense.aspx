<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PayExpense.aspx.cs" Inherits="SalesApp.PayExpense" %>
...
<div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="#">Pay Expense</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                                    ...
                                    <asp:MultiView ID="MultiView1" runat="server">
                                            ...
                                            <asp:GridView ID="gvEmployee" CssClass="table table-condensed compact table-hover table-responsive" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Expense">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblExpenseName" runat="server" Text='<%#Eval("ExpenseType") %>'></asp:Label>
                                                        </ItemTemplate>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            <div class="row">
                                                ...
                                                <div class="input-field col s6">
                                                    <asp:TextBox runat="server" CssClass="validate" ID="txtCNIC" TextMode="Date" />
                                                   
                                                    <asp:RequiredFieldValidator ID="rv16" runat="server" ControlToValidate="txtCNIC" ErrorMessage="*Please Enter Date" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    ...
                                                    <label for="txtCell">Amount</label>
                                                    <asp:RequiredFieldValidator ID="rv18" runat="server" ControlToValidate="txtCell" ErrorMessage="*Please Enter Amount" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer" 
                                                    ControlToValidate="txtCell" ErrorMessage="Please only type number" />
                                                </div>
                                                    <div class="input-field col s6">
                                                    <asp:TextBox style="border-bottom:solid;border-width:1px;border-color:gray;position:absolute" CssClass="validate" id="txtEmpCode" TextMode="multiline" Columns="50" Rows="5" runat="server" />
                                                    <%-----<asp:TextBox runat="server" CssClass="validate" ID="txtEmpCode" />----%>
                                                    <label for="txtCell">Description</label>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmpCode" ErrorMessage="*Please Enter Description" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <asp:Button Text="Submit Expense" runat="server" ID="btnAddEmployee" CssClass="btn btn-large" OnClick="btnAddEmployee_Click" />
