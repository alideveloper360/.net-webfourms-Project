...
namespace BarcodeLib
{
    ...
    public class Barcode: IDisposable
    {
        ...
        public Bitmap Encode(TYPE iType, string StringToEncode, int Width, int Height)
        {
            this.Width = Width;
            this.Height = Height;
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public Bitmap Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor, int Width, int Height)
        {
            this.Width = Width;
            this.Height = Height;
        ...
        /// <param name="BackColor">Background color</param>
        /// <returns>Image representing the barcode.</returns>
        public Bitmap Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor)
        {
        ...
        /// <param name="StringToEncode">Raw data to encode.</param>
        /// <returns>Image representing the barcode.</returns>
        public Bitmap Encode(TYPE iType, string StringToEncode)
        {
        ...
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        internal Bitmap Encode(TYPE iType)
        {
            Encoded_Type = iType;
            return Encode();
        }//Encode()
