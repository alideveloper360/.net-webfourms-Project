...
namespace SalesApp
{
    public partial class ShopStockReport : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter(@"select C_Name, P_Name, SKU, Value , Total_Quantity, Send_Quantity from Shop_Stock", con);
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter(@"select C_Name, P_Name, SKU, Value , Total_Quantity, Send_Quantity from Shop_Stock where Date Between '"+ txtDatefrom.Text+ "' AND '"+txtDateto.Text+"'", con);
