<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Mng_Zakat.aspx.cs" Inherits="SalesApp.Mng_Zakat" %>
                                ...
                                <ContentTemplate>
                                    <asp:MultiView ID="MultiView1" runat="server">
                                        <asp:View ID="View1" runat="server">
                                            ...
                                            <asp:Button Text="Add Amount" runat="server" ID="btnAddAmount" CssClass="btn btn-large" OnClick="btnAddAmount_Click"/>
                                            <br />
                                            <asp:Label ID="lblRowEntities" runat="server" ForeColor="Gray" Visible="false"/>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            <div class="row">
                                                ...
                                                <div class="col s6">
                                                    ...
                                                    <asp:TextBox runat="server" CssClass="validate" ID="txt_Zakat_TotalAmount" />
                                                    <asp:RequiredFieldValidator ID="rv16" runat="server" ControlToValidate="txt_Zakat_TotalAmount" ErrorMessage="*Please Enter Amount" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col s6">
                                                    <label for="txttotalAmount">Remaining Amount</label>
                                                    <asp:TextBox runat="server" CssClass="validate" ID="txtTotalAmountZakat" ReadOnly="true"/>  
                                               
                                                    </div>
                                                <div class="col s6">
                                                    <label for="txttotalAmount">Total Amount</label>
                                                    <asp:TextBox runat="server" CssClass="validate" ID="txtTotal_Amount" ReadOnly="true"/>  
                                                </div>
                                            </div>
                                        ...
                                        <asp:View ID="View3" runat="server">   
                                            <div class="row">
                                                ...
                                                <div class="col s6">
                                                    ...
                                                    <asp:textbox runat="server" CssClass="validate" ID="txtYear"/>  
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col s10"></div>
                                                <div class="col s2">
                                                    <asp:Button Text="Submit" ID="btnSubmit" runat="server" CssClass="btn btn-large" OnClick="btnSubmit_Click"/>
                                                </div>
                                            </div>
                                            ...
                                            <asp:Label runat="server" ID="UpdateAmount" Visible="false"/>
