<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeesLoanOut.aspx.cs" Inherits="SalesApp.EmployeesLoanOut" %>
     ...
     <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="#">Employee Loan paid</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                                ...
                                <ContentTemplate>
                                    <asp:MultiView ID="MultiView1" runat="server">
                                        <asp:View ID="View1" runat="server">
                                            <asp:Label id="t_Amount" runat="server" Visible="false"/>
                                            ...
                                            <asp:GridView ID="gvCommittee" CssClass="table table-condensed compact table-hover table-responsive" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Amount Paid">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDuration" runat="server" Text='<%#Eval("PaidAmount") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtGridDuration" runat="server" Text='<%#Eval("PaidAmount") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            <div class="row">
                                                ...
                                                <div class="col s6">
                                                    ...
                                                    <asp:TextBox runat="server" CssClass="validate" ID="txtAmount" ReadOnly="true"/>
                                            ...
                                            <div class="row">
                                                 <div class="col s6">
                                                        <label for="txtLoanDate">Pay Amount</label>
                                                    <asp:TextBox runat="server" CssClass="validate" ID="PayAmount" />
                                                   <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer" 
                                                    ControlToValidate="PayAmount" ErrorMessage="Please only type number" /> 
                                                </div>
                                             </div>
