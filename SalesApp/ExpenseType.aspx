<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ExpenseType.aspx.cs" Inherits="SalesApp.ExpenceType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                <li><a href="#"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
                <li class="active-bre"><a href="#">Add Expense</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                                ...
                                <ContentTemplate>
                                    <asp:MultiView ID="MultiView1" runat="server">
                                        <asp:View ID="View1" runat="server">
                                            ...
                                            <asp:GridView ID="gvDesignation" runat="server" BackColor="White" BorderColor="#CCCCCC" CssClass="table table-condensed compact table-hover table-responsive" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false"
                                                OnRowCancelingEdit="gvCategory_RowCancelingEdit" OnRowDataBound="gvCategory_RowDataBound" OnRowEditing="gvCategory_RowEditing" OnRowUpdating="gvCategory_RowUpdating" OnRowDeleting="gvCategory_RowDeleting">
                                                 ...
                                                 <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ExpenseType">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblName" runat="server" Text='<%#Eval("ExpenseType") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtName" runat="server" Text='<%#Eval("ExpenseType") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    ...
                                                    <label for="txtCategory">Expense</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="right-align">
                                                    <asp:LinkButton Text="Go To ExpenseType" ID="btnBack" runat="server" OnClick="btnBack_Click" CausesValidation="false" />
                                                </div>
                                            </div>
                                        </asp:View>
                                    </asp:MultiView>
