<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VendorLea.aspx.cs" Inherits="SalesApp.VendorLea" %>
                                ...
                                <ContentTemplate>
                                    <asp:MultiView ID="MultiView1" runat="server">
                                        <asp:View ID="View1" runat="server">
                                            ...
                                            <div class="row">
                                                  <div class="col s3">
                                                       <label for="lblRetailPrice">Bill Amounts:</label>
                                                    <asp:Label runat="server" ID="lblRetailPrice" />
                                                </div>
                                            
                                           
                                               <div class="col s3">
                                                       <label for="lblPayable">Remaining Amounts:</label>
